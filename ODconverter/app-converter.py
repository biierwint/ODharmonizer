...
# Step 1: Create Observation Table
if analysis_type:
    st.markdown("### Step 1: Create Observation Table")
    run_observation_step(enable_download)

# Step 2: Create Specimen Table
if "observation_df" in st.session_state and "person_path" in st.session_state:
    st.markdown("---")
    st.markdown("### Step 2: Create Specimen Table")
